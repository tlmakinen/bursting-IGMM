...
class MainWindow(QtGui.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('FQ_PostAnqlysis')
    ...
    def load_data(self):
        ...
        self.xls_data_fname  =  str(QtGui.QFileDialog.getOpenFileName(None, "Select the .xls file of the analyzed lsm file", filter="*.xlsx *.xls"))
